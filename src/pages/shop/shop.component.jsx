...
import CollectionList from "../../components/collecton-item/collection-list"
...
class Shop extends React.Component{
    ...
    render(){
        return (
            <div>
                {this.state.collection.map(({id,title,items}) => (<CollectionList key = {id} items = {items} title = {title}/>))}
            </div>
        )
    }
